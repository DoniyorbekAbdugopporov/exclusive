    ...
    <div className="max-w-6xl mx-auto px-4 py-10 grid md:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <div className="flex items-center mt-2">
          <p className="text-gray-500">({product.rating} Reviews)</p>
          <p className="text-green-500 ml-4">In Stock</p>
        </div>
        <div>
          ...
          <div className="flex gap-2 mt-2">
            {["XS", "S", "M", "L", "XL"].map((size) => (
              <button
                ...
                className={`px-3 py-1 border rounded-lg hover:bg-secondary hover:text-[#fff] transition-all duration-200 ${
                  selectedSize === size ? "bg-secondary text-[#fff]" : ""
                }`}
              >
                {size}
              </button>
        ...
        <div className="mt-6 flex items-center gap-4">
          <div className="flex items-center border rounded-lg overflow-hidden">
            <button
              className="px-3 py-1 border-r hover:bg-secondary hover:text-[#fff]"
            ...
            <button
              className="px-3 py-1 border-l hover:bg-secondary hover:text-[#fff]"
          ...
          <button className="bg-secondary text-[#fff] px-6 py-2 rounded-lg hover:bg-[#f35757]">
            Buy Now
          </button>
          <button className="p-2 border rounded-lg hover:bg-gray-200 transition">
            <FaRegHeart className="text-lg" />
          </button>
        </div>

        <div className="mt-6 border pt-4 border-gray-500 rounded p-8">
