...
const Header = () => {
  return (
    <div className="bg-primary h-12 flex justify-between items-center px-4 max-sm:flex-col max-sm:h-auto max-sm:py-2">
      <div className="flex space-x-2 container justify-center max-sm:flex-col max-sm:items-center max-sm:text-center">
        ...
        <select className="bg-transparent text-[#000] py-1 text-sm max-md:text-xs max-sm:text-[10px] max-sm:mt-2 px-5 mr-24">
